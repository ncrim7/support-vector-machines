...
# 3. Pipeline: Ölçeklendirme (StandardScaler) + SVC (kernel='poly')
pipeline = Pipeline([
...
# gamma : polynomial kernelde etki alanı parametresi
# degree: polinom derecesi
param_grid = {
    "svc__C": [0.01, 0.1, 1, 10, 100],
    "svc__gamma": [0.01, 0.1, 1, 10, "scale"],  # "scale", sklearn'in önerilen otomatik ayarı
    "svc__degree": [2, 3, 4]
}

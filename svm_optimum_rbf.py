...
# 3. Pipeline: Ölçeklendirme (StandardScaler) + SVC (RBF Kernel)
pipeline = Pipeline([
...
# C: Düzenleme parametresi, gamma: RBF kernel parametresi
param_grid = {
    "svc__C": [0.01, 0.1, 1, 10, 100],
    "svc__gamma": [0.01, 0.1, 1, 10, "scale"]
}

# 5. GridSearchCV ile En İyi C ve gamma Değerlerini Bulma
